...
import info.kmdb.JHipsterIonicApp;
import info.kmdb.domain.Entry;
import info.kmdb.repository.EntryRepository;
...
import static info.kmdb.web.rest.TestUtil.sameInstant;
import static info.kmdb.web.rest.TestUtil.createFormattingConversionService;
 ...
 */
@SpringBootTest(classes = JHipsterIonicApp.class)
