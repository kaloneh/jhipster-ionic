...
export class Entry extends React.Component<IEntryProps, IEntryState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="entry-heading">
          <Translate contentKey="jHipsterIonicApp.entry.home.title">Entries</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jHipsterIonicApp.entry.home.createLabel">Create a new Entry</Translate>
          </Link>
        </h2>
          ...
          >
            {entryList && entryList.length > 0 ? (
                ...
                <thead>
                  <tr>
                    ...
                    <th className="hand" onClick={this.sort('title')}>
                      <Translate contentKey="jHipsterIonicApp.entry.title">Title</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('content')}>
                      <Translate contentKey="jHipsterIonicApp.entry.content">Content</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('date')}>
                      <Translate contentKey="jHipsterIonicApp.entry.date">Date</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th>
                      <Translate contentKey="jHipsterIonicApp.entry.blog">Blog</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th />
                  </tr>
                </thead>
              ...
              <div className="alert alert-warning">
                <Translate contentKey="jHipsterIonicApp.entry.home.notFound">No Entries found</Translate>
              </div>
            )}
          </InfiniteScroll>
        </div>
