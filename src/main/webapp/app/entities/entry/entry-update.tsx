    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jHipsterIonicApp.entry.home.createOrEditLabel">
              <Translate contentKey="jHipsterIonicApp.entry.home.createOrEditLabel">Create or edit a Entry</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : entryEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="titleLabel" for="entry-title">
                    <Translate contentKey="jHipsterIonicApp.entry.title">Title</Translate>
                  </Label>
                  <AvField
                    id="entry-title"
                    type="text"
                ...
                <AvGroup>
                  <Label id="contentLabel" for="entry-content">
                    <Translate contentKey="jHipsterIonicApp.entry.content">Content</Translate>
                  </Label>
                  <AvInput
                    id="entry-content"
                    type="textarea"
                ...
                <AvGroup>
                  <Label id="dateLabel" for="entry-date">
                    <Translate contentKey="jHipsterIonicApp.entry.date">Date</Translate>
                  </Label>
                  <AvInput
                    id="entry-date"
                    type="datetime-local"
                ...
                <AvGroup>
                  <Label for="entry-blog">
                    <Translate contentKey="jHipsterIonicApp.entry.blog">Blog</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="entry-tag">
                    <Translate contentKey="jHipsterIonicApp.entry.tag">Tag</Translate>
                  </Label>
                  <AvInput
                    id="entry-tag"
                    type="select"
