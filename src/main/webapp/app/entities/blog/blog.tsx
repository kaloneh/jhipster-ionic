...
export class Blog extends React.Component<IBlogProps> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="blog-heading">
          <Translate contentKey="jHipsterIonicApp.blog.home.title">Blogs</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jHipsterIonicApp.blog.home.createLabel">Create a new Blog</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {blogList && blogList.length > 0 ? (
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="jHipsterIonicApp.blog.name">Name</Translate>
                  </th>
                  <th>
                    <Translate contentKey="jHipsterIonicApp.blog.handle">Handle</Translate>
                  </th>
                  <th>
                    <Translate contentKey="jHipsterIonicApp.blog.user">User</Translate>
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="jHipsterIonicApp.blog.home.notFound">No Blogs found</Translate>
            </div>
          )}
        </div>
      </div>
