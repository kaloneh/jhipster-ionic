...
export class Tag extends React.Component<ITagProps, ITagState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="tag-heading">
          <Translate contentKey="jHipsterIonicApp.tag.home.title">Tags</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jHipsterIonicApp.tag.home.createLabel">Create a new Tag</Translate>
          </Link>
        </h2>
          ...
          >
            {tagList && tagList.length > 0 ? (
                ...
                <thead>
                  <tr>
                    ...
                    <th className="hand" onClick={this.sort('name')}>
                      <Translate contentKey="jHipsterIonicApp.tag.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th />
                  </tr>
                </thead>
              ...
              <div className="alert alert-warning">
                <Translate contentKey="jHipsterIonicApp.tag.home.notFound">No Tags found</Translate>
              </div>
            )}
          </InfiniteScroll>
        </div>
